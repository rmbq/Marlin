...
#define STRING_CONFIG_H_AUTHOR "rmbq" // Original author or contributor.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  23.2
    #define DEFAULT_Ki   4.4
    #define DEFAULT_Kd  30.1
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 127.21
  #define DEFAULT_bedKi  17.30
  #define DEFAULT_bedKd 623.65
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.24, 80.26, 400.37, 432.89 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 15000, 15000, 1000, 15000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -13, -2.76 }
