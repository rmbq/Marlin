...
#define DWIN_BUTTON_NO (0xF0)
  ...
  typedef enum : unsigned long
  {
    DWIN_VP_START = 0x1053,
    DWIN_VP_MAIN = 0x1002,
    DWIN_VP_FILE_SEL = 0x20D2,
    DWIN_VP_SETTINGS = 0x103E,
    DWIN_VP_TOOLS = 0x105C,
    DWIN_VP_STEP_LVL = 0x105B,
    DWIN_VP_SPEED_CFG = 0x1059,
    DWIN_VP_DISPLAY_CFG = 0x1044,
    DWIN_VP_PID_LVL = 0x1057,
    DWIN_VP_LEVELING = 0x1055,
